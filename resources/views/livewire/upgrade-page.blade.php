<div>
    <div class="container grid mx-auto lg:grid-cols-3 auto-cols-fr lg:gap-2">
        <div class="my-1">
            <img src="\storage\{{ $upgrade->image }}" class="mx-auto border-2 border-black rounded-lg card__image"></a>
        </div>
                ...
                <div class="mb-2 bg-gray-200 border-2 border-black rounded">
                    ...
                    <div class="mx-2 mb-2">
                        @foreach ($upgrade->minis as $mini)
                            <a href="{{ route('character.view', $mini->slug) }}"
                                class="inline-block text-center p-0.5 text-white border border-black rounded-full
