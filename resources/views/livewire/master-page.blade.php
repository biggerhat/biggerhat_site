    ...
    <div class="container grid w-full grid-cols-1 gap-0 px-2 mx-auto mt-3 text-center lg:grid-cols-2 auto-cols-fr">
        ...
        <div>
            ...
            <div class="grid mb-2 text-center">
                <div class="">
                    <div class=" grid w-full grid-cols-5 mx-auto mb-2 lg:px-2
                        ...
                        <div class="grid grid-cols-4 mx-auto">
                            ...
                            <div class="text-center">
                                <div class="inline-block mx-auto text-sm text-center">
                                    ...
                                    <div
                                        class="block w-16 h-16 {{ $background }} text-white rounded-full text-center mx-auto align-middle table-cell @if ($averageGunRange > 9) text-3xl @else text-5xl @endif text-bold border-2 border-gray-900 average font-mono">
                                        {{ $averageGunRange }}
                                    </div>
                                </div>
                            </div>
