    ...
    <div class="mx-1 mb-3 sm:my-3 md:m-0">
        <div class="mb-2 bg-gray-200 border-2 border-black rounded shadow-md">
            ...
            <div class="mx-2 mb-2">
                ...
                <p class="pb-1 mb-1 text-xl font-semibold">Faction(s): @foreach($mini->factions as $faction)<a href="/factions/{{$faction->id}}/{{Str::slug($faction->name,'-')}}" class="inline-block text-center p-0.5 text-white rounded-full bg-{{$faction->bg_color}} px-2 py-1 text-sm font-bold">{{ strtoupper($faction->name) }}</a> @endforeach</p>
                <div class="block my-1 border-b border-gray-400 border-dashed"></div>
                <p class="pb-1 mb-1 text-xl font-semibold">Keyword(s): @foreach($mini->keywords as $keyword)<a href="/keywords/{{$keyword->id}}/{{Str::slug($keyword->name,'-')}}" class="inline-block text-center p-0.5 text-white rounded-full {{ $background }} px-2 py-1 text-sm font-bold mr-3">{{ strtoupper($keyword->name) }}</a>@endforeach</p>
                <div class="block my-1 border-b border-gray-400 border-dashed"></div>
...
<div class="container grid mx-auto auto-cols-fr lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-x-2">
                ...
                <div class="bg-gray-200 border-2 border-black rounded">
                    ...
                    <div class="mx-2 mb-2">
                        @foreach($mini->promos as $promo)
                            <a href="/promos/{{$promo->id}}/{{Str::slug($promo->name,'-')}}" class="inline-block text-center p-0.5 text-white rounded-full {{$background}} px-2 py-1 text-xs font-bold mb-1 cursor-pointer">{{ strtoupper($promo->name) }}</a><br/>
                        @endforeach
                    </div>
                </div>
            </div>
        ...
        <div class="mx-1 mb-2 sm:my-2">
            <div class="bg-gray-200 border-2 border-black rounded">
                ...
                <div class="mx-2 mb-2 text-sm">
                    <button wire:click='launchUpgradeModal'>Bigger Hat Club - Som'er vs Basse (Video)</button>
                </div>
            </div>
        </div>
</div>
