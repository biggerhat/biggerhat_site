...
<div>
    ...
    <div class="container grid mx-auto mb-3 auto-cols-fr lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-x-3">
        ...
        <div class="p-0 m-0 mb-3 md:col-span-2 lg:col-span-1">
            ...
            <div
                class="w-12 px-2 py-2 mx-auto mt-2 text-xs font-medium leading-6 text-center text-gray-900 transition bg-transparent border-2 border-black rounded-full shadow flipper ripple hover:shadow-lg hover:bg-gray-100 focus:outline-none">
                    ...
                    <div class="mx-2 bg-gray-200 border-2 border-black rounded md:mx-auto">
                        ...
                        <div class="px-5 py-5 mx-auto text-md">
                            <div class="flex mx-auto bg-gray-900 rounded-full" style=" @if ($markerSize==50) width: 188px; height: 188px; @endif
                                @if ($markerSize == 40)width: 151px; height:
