    ...
    <div
        ...
        <div class="mx-1 mb-3 sm:my-3 md:m-0 xl:col-span-3 lg:col-span-2 md:col-span-2">
            <div class="mb-2 bg-gray-200 border border-t-4 border-b-4 border-black rounded shadow-lg">
                <div
                    class="block p-1 mb-2 text-xl font-medium text-gray-100 border-b border-gray-900 {{ $background }}">
                    {{ $mini->name }}</div>
                <div class="mb-2 ">
                    @if ($original)
                        <p class="pb-1 pl-1 mb-1 font-semibold text-md">Title for:
                    ...
                    @endif
                    <p class="pb-1 pl-1 mb-1 font-semibold text-md">Station: <a
                    ...
                    <div class="block my-1 border-b border-gray-400 border-dashed"></div>
                    <p class="pb-1 pl-1 mb-1 font-semibold text-md">Faction(s): @foreach ($mini->factions as $faction)<a href="/factions/{{ $faction->slug }}"
                        ...
                        @endforeach</p>
                    <div class="block my-1 border-b border-gray-400 border-dashed"></div>
                    <p class="pb-1 pl-1 mb-1 font-semibold text-md">Keyword(s): @foreach ($mini->keywords as $keyword)<a
                        ...
                        @endforeach</p>
                    <div class="block my-1 border-b border-gray-400 border-dashed"></div>
                    <p class="pb-1 pl-1 mb-1 font-semibold text-md">Characteristic(s): @foreach ($mini->characteristics as $characteristic)<a
            ...
            <div class="mx-1 mb-2 sm:my-2">
                <div class="bg-gray-200 border-2 border-black rounded">
                    <div
                        ...
                        </svg>Related Upgrades
                    </div>
                    <div class="mx-2 mb-2">
                        @foreach ($mini->upgrades as $upgrade)
                            <button wire:click="openUpgradeModal({{ $upgrade->id }})"
                                class="inline-block text-center p-0.5 border border-black text-white rounded-full focus:outline-none {{ getUpgradeBackground($upgrade) }} px-2 py-1 font-bold mb-1">{{ strtoupper($upgrade->name) }}</button><br />
                        @endforeach
                    </div>
                </div>
            </div>
                ...
                <div class="table-cell text-center align-middle">
                    <div class="mx-2 bg-gray-200 border-2 border-black rounded md:mx-auto">
                        ...
                        <div class="px-5 py-5 mx-auto text-md">
                            <div class="flex mx-auto bg-gray-900 rounded-full" style=" @if ($markerSize == 50) width: 188px; height: 188px; @endif
