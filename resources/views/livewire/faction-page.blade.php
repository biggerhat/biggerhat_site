    ...
    <div class="container grid w-full grid-cols-1 gap-0 px-2 mx-auto mt-3 lg:grid-cols-2 auto-cols-fr">
        ...
        <div class="grid w-full grid-cols-5 mx-auto mb-2 lg:px-2 auto-cols-fr auto-rows-min">
            ...
            <div class="col-span-5 mb-2 text-center">
                <div class="block w-full h-full py-2 text-center">
                    <span class="text-transparent lg:text-4xl text-3xl bg-clip-text bg-gradient-to-br from-{{$faction->bg_color}} via-gray-700 to-{{$faction->bg_color}} faction_header">
                        Averages
                    </span>
                </div>
            </div>
            <div class="text-center">
                <div class="inline-block mx-auto text-sm text-center">
                    Defense
                    <div class="block w-16 h-16 bg-{{ $faction->bg_color }} text-white rounded-full text-center mx-auto align-middle table-cell text-5xl text-bold border-2 border-gray-900 average font-mono">
                        {{ $averageDf }}
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-4 mx-auto">
                    ...
                    <div class="text-center">
                        <div class="inline-block mx-auto text-sm text-center">
                            ...
                            <div class="block w-16 h-16 bg-{{ $faction->bg_color }} text-white rounded-full text-center mx-auto align-middle table-cell @if($averageGunRange > 9) text-3xl @else text-5xl @endif text-bold border-2 border-gray-900 average font-mono">
                                {{ $averageGunRange }}
                            </div>
                        </div>
                    </div>
            ...
            <!--
            <div class="col-span-5 mt-4 text-center text-8xl">
                <span class="text-transparent  lg:text-4xl md:text-7xl text-5xl bg-clip-text bg-gradient-to-br from-{{$faction->bg_color}} via-gray-700 to-{{$faction->bg_color}} faction_header">
                    *All this made possible thanks to some guy from Tennessee
                </span>
            </div> -->
        </div>
        ...
        <div>
            <div class="mb-2 bg-gray-200 border-2 border-black rounded">
                <div class="block p-1 mb-2 text-xl font-medium text-white align-middle border-b border-black bg-{{$faction->bg_color}}">
