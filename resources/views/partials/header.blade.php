    ...
    <nav class="px-5 bg-gray-900">
        <ul class="flex flex-wrap items-center justify-between font-sans list-none md:py-0 menu lg:flex-nowrap">
                    ...
                    @if (Request::path() != '/')
                        <form method="POST" action="{{ route('results') }}" autocomplete="off"
                            ...
                            <input type="search" name="search" placeholder="Search"
                                class="w-full h-8 px-2 my-auto text-sm bg-gray-200 rounded-l-full rounded-r-full focus:outline-none"
                                autocomplete="off" />
                        </form>
            ...
            <li class="order-3 hidden w-full p-2 text-center item lg:block lg:w-auto lg:relative"><a
                    ...
                    class="block p-3 text-gray-200 rounded-lg hover:text-white hover:bg-gray-700">Characters</a></li>
            <li class="order-3 hidden w-full p-2 text-center item lg:block lg:w-auto lg:relative"><a
                    href="{{ route('spoilers') }}"
                    class="block p-3 text-gray-200 rounded-lg hover:text-white hover:bg-gray-700">Spoilers</a></li>
            <li class="order-3 hidden w-full p-2 text-center item lg:block lg:w-auto lg:relative"><a
                    href="{{ route('resources') }}"
                    class="block p-3 text-gray-200 rounded-lg hover:text-white hover:bg-gray-700">Resources</a></li>
            ...
            <li class="order-1 toggle lg:hidden md:visible">
                <a class="cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style="height: 32px; width: 32px;">
                        <g class="" transform=" translate(0,0)" style="">
                            <path d="M32 96v64h448V96H32zm0 128v64h448v-64H32zm0 128v64h448v-64H32z" fill="#ffffff"
                                fill-opacity="1"></path>
                        </g>
                    </svg>
                </a>
